...
public class Executable{
	...
	*/
	...
	public void registerSpecie(){
		...
		cont.asociarSpecieConPlace(cont.createSpecie(nameSpecie, cont.tipoEspecie(typeSpecie) , pictureSpecie ,quantitySpecie), cont.searchPlace(namePlace));
	...
	public void registerProduct(){
		...
		System.out.println(cont.showCommunities());
		...
		*/
		...
		if(cont.searchCommunity(comunidad) != null){
			cont.asociarProductoConComunidad(cont.createProduct(nameProduct, percentage, cont.tipoProducto(tipoProductoDecision), cont.handmade(handmadeDecision)), cont.searchCommunity(comunidad));
	...
	public void registerPlace(){
		...
		if (inaugurationDate != null) {
			...
			if (cont.searchPlace(namePlace) == null) {
				...
				System.out.println("El lugar que desea registrar ya existe, por favor registra otro lugar.");
			}
		}
