...
public class Controller{
	...
	public void asociarProductoConComunidad(Product product, Community community){
		community.addProduct(product);
	}

	public void asociarSpecieConPlace(Specie specie, Place place){
